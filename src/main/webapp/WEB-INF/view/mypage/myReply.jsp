...
<script>
	...
	function fn_search(writerID) {
		...
		if (name == '정보게시판')
			url = url + "myreply-info";
		if (name == '질문게시판')
			url = url + "myreply-Iiquiry";
		if (name == '중고게시판')
			url = url + "myreply-secondhand";
		if (name == '공구게시판')
			url = url + "myreply-gpurchase";
		if (name == '매칭게시판')
			url = url + "myreply-petsitter";
		if (name == '리뷰게시판')
			url = url + "myreply-review";
