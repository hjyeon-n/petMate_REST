				...
				<tbody>
					<c:forEach var="secondhandCart" items="${secondhandCartList}">
						<tr>
							...
							<td><a href="<c:url value="/secondhand/${secondhandCart.boardNum}"></c:url>">
					...
					<li><a href="#" data-toggle="modal" data-target="#myModal">회원 정보 수정</a></li>
          			<li>
			            ...
			            <ul class="collapse list-unstyled" id="pageSubmenu2">
			                ...
			                <li><a href="mypage-inquriy"><span class="fa fa-chevron-right mr-2"></span>질문 게시판</a></li>
	          		...
	          		<li>
			            ...
			            <ul class="collapse list-unstyled" id="pageSubmenu3">
			                ...
			                <li><a href="myreply-inquriy"><span class="fa fa-chevron-right mr-2"></span>질문 게시판</a></li>
...
<script>
	...
	$(document).on("click","#btnOrder", function() {
	    ...
	    $.ajax({
	        url: '${pageContext.request.contextPath}/secondhand-cart/order',
	        type: 'post',
	        data: { secondhandCartList : checkArr,
		        	sprice : price },
	    	success : function(result) {
				alert(result);
				location.href = "${pageContext.request.contextPath}/secondhand/order";
			}
	    });
	});
